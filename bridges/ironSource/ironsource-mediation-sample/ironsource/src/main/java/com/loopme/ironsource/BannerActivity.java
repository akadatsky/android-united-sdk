...
public class BannerActivity extends Activity {
    // private static final String appKey = "19849b245"; // errorCode:600, errorMessage:Init() had failed
     private static final String appKey = "124e1d38d"; // errorCode:615, errorMessage:the server response does not contain banner data
    // private static final String appKey = "127d76565"; // errorCode:1044, errorMessage:no available ad to load
    private static final String loopmeAppKey = "f5826542ae"; // banner 300x50
